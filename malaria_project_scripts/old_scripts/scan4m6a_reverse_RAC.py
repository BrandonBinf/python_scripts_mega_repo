...
def read_sequence_from_file(filename):
	fasta_data = {}
	with open(filename, "r") as file: #changed to readable
		for record in SeqIO.parse(file, "fasta"):
			...
			rna_seq = str(rev_comp_dna.transcribe())
...
def main():
    ...
    parser.add_argument(
        "-o", "--output",
        type=str,
        default="/home/bbendick/malaria_work/scan4m6a_stops_reverse_RAC.tsv",
        help="Name and location of desired output file (default: scan4m6a_stops_reverse.tsv)"
    )
